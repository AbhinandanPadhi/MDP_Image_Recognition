...
public class RealRobot extends Robot{
	...
	// Receive sensor values to acknowledge the action had performed by the Arduino
	...
	// Send the mdf string every 2 times we receive the sensor value
	public void sendMDPString() {
		if (this.numOfCount == 1) {
	...
	public void forward(int step) {
		...
		int[] result  = new int[]{pos[0],pos[1],this.getDirection()};
		connectionSocket.sendMessage("P{\"Position\":" + Arrays.toString(result) + "}\n");
